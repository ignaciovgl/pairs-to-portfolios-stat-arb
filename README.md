...
* `paper/`
  * [`From_Pairs_to_Portfolios__A_Guide_to_Cointegration_and_Statistical_Arbitrage.pdf`](From_Pairs_to_Portfolios_A_Guide_to_Cointegration_and_Statistical_Arbitrage.pdf) - *The full publication.*
